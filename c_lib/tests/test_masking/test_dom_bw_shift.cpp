...
TEST_CASE("Second-order DOM shift right 8bit gadget computes correctly", "[unittest][dom]") {
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        dom_bw_shiftr8(masked_x, out, shift);

        const uint8_t expected_result = um_x >> shift;
...
TEST_CASE("Second-order DOM shift right 32bit gadget computes correctly", "[unittest][dom]") {
    constexpr unsigned int iterations = 100;
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        dom_bw_shiftr32(masked_x, out, shift);

        const uint32_t expected_result = um_x >> shift;
...
TEST_CASE("Second-order DOM shift right 64bit gadget computes correctly", "[unittest][dom]") {
    constexpr unsigned int iterations = 100;
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        dom_bw_shiftr64(masked_x, out, shift);

        const uint64_t expected_result = um_x >> shift;
...
TEST_CASE("Second-order DOM shift left 8bit gadget computes correctly", "[unittest][dom]") {
    constexpr unsigned int iterations = 100;
    const uint8_t shift = 3;
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        uint8_t out[N_SHARES];
        dom_bw_shiftl8(masked_x, out, shift);
...
TEST_CASE("Second-order DOM shift left 32bit gadget computes correctly", "[unittest][dom]") {
    constexpr unsigned int iterations = 100;
    const uint8_t shift = 17;
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        uint32_t out[N_SHARES];
        dom_bw_shiftl32(masked_x, out, shift);
...
TEST_CASE("Second-order DOM shift left 64bit gadget computes correctly", "[unittest][dom]") {
    constexpr unsigned int iterations = 100;
    const uint8_t shift = 47;
    ...
    for (int i = 0; i < iterations; ++i) {
        ...
        uint64_t out[N_SHARES];
        dom_bw_shiftl64(masked_x, out, shift);
