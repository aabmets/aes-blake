...
def test_aesblake512_reference_inputs():
    ...
    cipher = AESBlake512(key, nonce, context)
    ciphertext, auth_tag = cipher.encrypt(plaintext, header)

    assert ciphertext == bytes.fromhex(
        "D0461416 DCC603E7 7575F52E 2723DFBC"
        "71343AB1 66141913 ADF9F087 2D89D110"
        "DD5C0112 69B40CA8 8620EA51 E4A2640E"
        "1E3BA638 E8AC9D04 302EDE2F FB197FF3"
        "18766ED3 0134AC5C C2834ECA DC0DD667"
        "BF0C797D 27811D1B C954AC14 168E7B5E"
        "6489A68D 3800B46F 144630D7 2A701CC1"
        "D7CF209A 8DCDD7BE B7584A53 FB7FDF25"
    )
    assert auth_tag == bytes.fromhex(
        "64432423 C30F1D5A D22DFF78 D5BB15D7"
        "33D37F56 D7418F80 F3585296 6767F94A"
        "1C99884C 3639ED27 235531F7 9D8ECEC5"
        "DFB5B6D7 B67E823C BB1B012F 7CA443CD"
    )
