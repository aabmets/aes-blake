...
def test_normal_init():
	...
	expected_vector = [
		0xAF8A1F9A, 0x4FCDE385, 0x2EFB3FC6, 0x1E285A8F,
		0x1B8C9BA8, 0xA0A3B783, 0x2A992AE7, 0x6BED37E5,
		0xE07F850E, 0x01E0185A, 0x17DDC33E, 0x10C00AE5,
		0x019C582D, 0xC24693ED, 0xEC9D4C75, 0x8225941B
	]
	expected_aes_vector = [
		0x1B, 0x8C, 0x9B, 0xA8,
		0xA0, 0xA3, 0xB7, 0x83,
	...
	assert blake.block_index.value == 0x7CDE6AD8255ADC55
